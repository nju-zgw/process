    ...
    <aside>
        <div id="sidebar" class="nav-collapse ">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="mt">
                    <a class="active" href="<%=request.getContextPath()%>/allRisks">
                                    ...
                                    <a class="col-md-8 col-md-offset-1 mb" href="lookRisk/${item.riskId}">
                                        ...
                                        <div class="white-panel pn" style="height:20%" >
                                            <div class="white-header">
                                                <h5> <c:out value="${item.project}"/></h5>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <p class="mt">风险类别：<c:out value="${item.riskType}"/></p>
                                                </div>
                                                <div class="col-md-3">
                                                    <p class="mt">风险严重性：<c:out value="${item.riskAffect}"/></p>
                                                </div>
                                                <div class="col-md-3">
